...
| **Nuvem (Cloud-Ready)** | **Docker, Docker Compose & Render** | Arquitetura conteinerizada em conformidade com a metodologia *12-Factor App*, preparada para deploy escalável em provedores de nuvem com execução automatizada no Render. | link de acesso público do projeto: https://conexao-solidaria-pi1.onrender.com
